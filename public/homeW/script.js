...
btn2.addEventListener('click', function() {
        ...
        <button class="btn_red_sliding" onclick="createOnclick()">Create</button>
        <button class="btn_round_red" onclick="joinOnclick()">Join</button>
    `;
});
...
function joinOnclick(){
    ...
    buttonContainer.innerHTML = `
        ...
        <button id="submitButton" class="btn_round_red" onclick="submitCode()" >Submit</button>
    `;
}
